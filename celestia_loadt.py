...
parser.add_argument("-c", "--calls", metavar='', help="number of calls to make (default 100)", type=int, default=100)
parser.add_argument("-t", "--threads", metavar='', help="number of threads to use (default 10)", type=int, default=10)
